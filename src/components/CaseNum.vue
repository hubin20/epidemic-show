<!--
  作者：hcodeb
  时间：2022年07月31日 11:32:39
-->
<template>
  <div class="case-num">
    <div class="container">
      <div class="title">
        <span>截至{{ formatDate(caseNumData.modifyTime) }}全国数据统计</span>
      </div>
    </div>
    <div class="num">
      <ul class="count">
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日
                <em style="color:rgb(247,76,49)">{{ numZero(caseNumData.currentConfirmedIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日
                <em style="color:rgb(247,130,7)">{{ numZero(caseNumData.suspectedIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日
                <em style="color:rgb(162,90,78)">{{ numZero(caseNumData.seriousIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日
                <em style="color:rgb(174, 33, 44)">{{ numZero(caseNumData.confirmedIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日
                <em style="color:rgb(93, 112, 146)">{{ numZero(caseNumData.deadIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日
                <em style="color:rgb(40, 183, 163)">{{ numZero(caseNumData.curedIncr) }}</em>
              </b>
            </div>
...
export default {
  ...
  methods: {
    formatDate(date) {
      ...
      var mm = d.getMinutes() < 10 ? "0" + d.getSeconds() : d.getSeconds()
